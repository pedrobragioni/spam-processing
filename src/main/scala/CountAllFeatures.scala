...
object CountAllFeatures {
  ...
  def main(args: Array[String]) {
    ...
    val m = hf.filter (_._2.From != "Invalid")
    ...
    msgs_proto.saveAsTextFile ("hdfs://master:8022/" + outputFile + ".msgs_protocol")
    ips_proto.saveAsTextFile ("hdfs://master:8022/" + outputFile + ".ips_protocol")
    ases_proto.saveAsTextFile ("hdfs://master:8022/" + outputFile + ".ases_protocol")
    ccs_proto.saveAsTextFile ("hdfs://master:8022/" + outputFile + ".ccs_protocol")
