...
public class CountLinesDriver extends Configured implements Tool {

   private static final Logger LOGGER = Logger.getLogger(
         CountLinesDriver.class.getName());
   ...
   public static void main(String[] args) throws Exception {
      int res = ToolRunner.run(new Configuration(), new CountLinesDriver(), args);
      System.exit(res);
   }
}
